      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <footer className="mt-12 mb-8">
          <div className="bg-white/40 backdrop-blur-xl border border-white/50 rounded-3xl p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl shadow-slate-200/50">
            ...
            <div className="flex items-center gap-4">
              {/* Social Links (Mock) */}
              <a href="#" className="p-2.5 bg-white/60 hover:bg-white text-slate-600 hover:text-blue-600 rounded-full transition-all hover:scale-110 shadow-sm border border-white/50 group">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
              </a>
              <a href="#" className="p-2.5 bg-white/60 hover:bg-white text-slate-600 hover:text-pink-600 rounded-full transition-all hover:scale-110 shadow-sm border border-white/50 group">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
              </a>
              <a href="#" className="p-2.5 bg-white/60 hover:bg-white text-slate-600 hover:text-emerald-600 rounded-full transition-all hover:scale-110 shadow-sm border border-white/50 group">
